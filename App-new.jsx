      ...
      roles: [
        {
          ...
          achievements: [
            ...
            "Designed autonomous cross Database SQL Deep agent to give insights of data."
          ]
        },
        {
  ...
  education: [
    {
      ...
      logo: "/iitg-logo.png",
      gpa: "8.60/10.0",
      coursework: ["Image Processing", "Computer Vision", "Machine Learning", "Reinforcement Learning"]
    },
    {
              ...
              {DATA.heroPhoto && (
                <div className="flex justify-center md:justify-end">
                  <div className="relative">
                    <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-blue-500/50 shadow-2xl ring-4 ring-blue-400/20">
                      <img
                        src={DATA.heroPhoto}
                        alt={DATA.name}
                    ...
                    <span className="absolute bottom-3 right-3 w-4 h-4 rounded-full bg-green-500 border-2 border-white dark:border-gray-900 shadow-md"></span>
                  </div>
                </div>
              )}
              <Card>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                {DATA.photo && (
                  <div className="flex-shrink-0">
                    <div className="w-36 h-36 rounded-2xl overflow-hidden border-2 border-blue-500/40 shadow-xl">
                      <img
                        src={DATA.photo}
                        alt={DATA.name}
                        className="w-full h-full object-cover"
                ...
                {exp.roles ? (
                  <div className="space-y-6">
                    {exp.roles.map((role, ridx) => (
                      <div key={ridx} className={ridx > 0 ? "pt-6 border-t border-gray-200 dark:border-gray-700" : ""}>
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3">
                          <h4 className="text-lg font-semibold text-gray-900 dark:text-white">{role.title}</h4>
                          <span className="text-sm text-gray-700 dark:text-gray-300 mt-1 md:mt-0">{role.period}</span>
                        </div>
                        <p className="text-gray-900 dark:text-white mb-3">{role.description}</p>
